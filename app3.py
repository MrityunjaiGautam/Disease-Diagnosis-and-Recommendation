...
dataset = pd.read_csv(r"/Users/mrityunjaigautam/Downloads/Disease-Diagnosis-and-Recommendation-System-main/datasets/general.csv")
...
heart_disease_model = pickle.load(open(r'models/heart_disease_model1.sav','rb'))
